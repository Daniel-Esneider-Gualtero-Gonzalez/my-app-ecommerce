  ...
  return (
    <section className="w-full shadow-shadowSection relative h-screen  rounded-lg">
      ...
      <article className="mt-[10%]  my-auto ml-5 absolute border-black w-fit px-2 ">
        ...
        <p className="mt-3 max-w-[400px]">¡Bienvenido al emocionante mundo de compras didácticas! En este espacio interactivo, te invitamos a recargar tu saldo virtual y sumergirte en una experiencia única de comercio <span className="text-secondary">electrónico</span>.!</p>
        <button className="p-2 flex bg-secondary  dark:text-black text-white font-bold hover:scale-105  transition-transform duration-200 mt-2   rounded ">Comenzar</button>
      </article>

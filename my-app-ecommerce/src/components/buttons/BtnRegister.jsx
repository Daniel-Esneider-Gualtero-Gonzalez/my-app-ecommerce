...
function BtnRegister({className}) {
  ...
  return (
    <>
    {!user && urlActual !== "singup"? <button onClick={()=> navigate("/singup")} className='mt-1 h-[40px] border py-2 px-2 w-[100px] rounded flex justify-center items-center border-blue-700'>Register</button> : null }
    </>
  )
}

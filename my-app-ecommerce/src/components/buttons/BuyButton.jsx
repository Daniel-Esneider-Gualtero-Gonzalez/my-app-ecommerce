    ...
    <>
      {location.pathname !== "/mi-carrito" ? <Link to={"/mi-carrito"}>
            <div className="fixed h-fit  hover:scale-105  right-3 bottom-3 z-49 ">
              ...
              <button className='relative mt-3  dark:bg-secondary dark:text-black    rounded-full      p-3'>
              <span className="bg-white rounded-full  absolute right-1 top-0 -mt-5">{cantProducts}</span>

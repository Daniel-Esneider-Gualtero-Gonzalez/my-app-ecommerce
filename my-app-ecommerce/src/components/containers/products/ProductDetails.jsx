        ...
        <div className='w-screen h-screen flex justify-between my-5 bg-gradient-to-b from-transparent via-transparent to-blue-100'>
            <div className='border '>
                ...
                <div className='w-fit mx-auto mt-5'>
                    <span>$7500</span>
                    <button className='bg-ble-600 rounded border p-2 bg-blue-600 text-white font-semibold'>ADD TO CART</button>
                </div>
            </div>

            <div>
                <img src="https://websitedemos.net/electric-scooter-04/wp-content/uploads/sites/1113/2022/07/scooter-01.png" alt="" />
            </div>

            <div className=''>
                more images
                <div className='flex'>
                    <div className='w-[80px] mx-1 bg-blue-400 h-[100px] rounded'></div>
                    <div className='w-[80px] mx-1 bg-blue-400 h-[100px] rounded'></div>
                    <div className='w-[80px] mx-1 bg-blue-400 h-[100px] rounded'></div>
                </div>

...
function Footer() {
  ...
  return (
    <>
      ...
      <footer className=" indexFooter rounded-lg ">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-2 md:mb-0">

              <Logo className="w-[120px] rounded" />
            ...
            <div className="grid grid-cols-2 gap-5  sm:grid-cols-3">
              <div>
                ...
                <ul className="">
                  ...
                  <li>
                    <a href="https://tailwindcss.com/" className="">Acerca de nosotros</a>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="">
                  <li className="mb-4">
                    <a href="#" className="">Privacidad - Política</a>
                  </li>
                  <li>
                    <a href="#" className="">Términos &amp; Condiciones</a>
                  </li>
                </ul>
              </div>
            </div>
          </div>
          <hr className="my-6 border-blue-600 sm:mx-auto dark:border-secondary lg:my-8" />

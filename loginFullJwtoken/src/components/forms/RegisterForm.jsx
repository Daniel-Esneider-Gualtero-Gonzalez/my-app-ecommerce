        ...
        <div className='h-full w-full '>
            <form className=' py-2 px-3 '>
                ...
                <div className='mt-2'>
                    ...
                    <div>
                        <div className='flex items-center '><div className='ml-1 absolute'>📧</div> <input className='px-8 w-full border rounded h-[45px] border-black focus:outline-none focus:border-blue-500' type="email" /></div>
                    </div>
                </div>
                ...
                <button className='mx-auto bg-blue-500 text-white font-bold text-xl hover:bg-blue-600 hover:scale-105 flex mt-10 border w-[40%] items-center py-2 justify-center rounded'>Registrarse</button>

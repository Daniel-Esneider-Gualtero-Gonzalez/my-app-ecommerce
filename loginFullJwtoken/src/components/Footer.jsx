...
function Footer() {
  ...
  const animateItemsLi = (listItems) => {
    ...
    for (let i = 0; i < listItems.length; i++) {
      ...
      listItems[i].animate([{ borderBottom: `${color} solid 1px`}], options)
  ...
  return (
    <>
      <footer ref={refFooter} className="relative py-20 flex flex-col items-center  overflow-hidden md:py-40">
